...
const communityLinks = [
  {
    ...
    description: 'Join our bi-weekly community meetings',
    icon: <Calendar className="w-10 h-10" />,
    href: 'https://calendar.google.com/calendar/shipwright-community',
  ...
  },
  {
    ...
    href: 'https://lists.cncf.io/g/cncf-shipwright-dev',
  ...
  },
  {
    ...
    icon: <Mail className="w-10 h-10" />,
    href: 'https://lists.cncf.io/g/cncf-shipwright-users',
    buttonText: 'Subscribe'
  }
];
